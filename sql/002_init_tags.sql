...
(3, 'resource_type', '资源类型', 'enum_multi',   false, true,  true,  9),
(3, 'special_system','特殊系统', 'enum_multi',   false, true,  true,  10),
(3, 'school',        '门派',     'enum_multi',   false, true,  true,  11),
(3, 'weapon_type',   '武器类型', 'enum_multi',   false, true,  true,  12),
(3, 'common_action', '通用动作分类', 'enum_multi', false, true, true,  13),
(3, 'mount_type',    '骑乘类型', 'enum_multi',   false, true,  true,  14),
(3, 'qinggong_type', '轻功类型', 'enum_multi',   false, true,  true,  15),
(3, 'core_action',   '核心动作', 'enum_multi',   false, true,  true,  16),
(3, 'file_type',     '文件类型', 'enum_multi',   false, true,  true,  17),
...
(2, 'length_cm',           '长度(cm)',   'number_range', false, true, false, 17, '{"min":0,"max":20000,"step":100,"unit":"cm","group":"尺寸"}'),
(2, 'width_cm',            '宽度(cm)',   'number_range', false, true, false, 18, '{"min":0,"max":20000,"step":100,"unit":"cm","group":"尺寸"}'),
(2, 'height_cm',           '高度(cm)',   'number_range', false, true, false, 19, '{"min":0,"max":20000,"step":100,"unit":"cm","group":"尺寸"}'),
(2, 'camera_distance',     '相机距离',   'number_range', false, true, false, 20, '{"min":0,"max":35000,"step":100,"group":"相机参数"}'),
(2, 'camera_scale',        '相机缩放',   'number_range', false, true, false, 21, '{"min":0,"max":8,"step":0.1,"group":"相机参数"}'),
